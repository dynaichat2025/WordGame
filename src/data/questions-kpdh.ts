...
export const kpdhQuestions: Question[] = [
  ...
  { id: 1718, sentence: '영화에서 헌트릭스가 아리랑을 현대적으로 편곡하여 혼문을 강화하는 장면이 나옵니다.', word: '아리랑', options: ['음식 이름', '한국의 유명한 전통 민요', '산 이름', '동물 이름'], answer: 1, difficulty: 'kpdh' },
  ...
  { id: 1789, sentence: '영화에서 혼문을 지키는 힘은 신성하다고 전해지며 악마도 함부로 다가가지 못합니다.', word: '신성하다', options: ['무섭다', '거룩하고 신처럼 존귀하다', '작다', '슬프다'], answer: 1, difficulty: 'kpdh' },
  ...
  { id: 1868, sentence: '영화에서 팬들이 스스로를 가디언즈라 부르며 헌트릭스를 응원합니다.', word: '가디언즈', options: ['파괴자', '지키는 사람들, 수호자들', '적', '구경꾼'], answer: 1, difficulty: 'kpdh' },
  { id: 1869, sentence: '영화에서 혼문은 오방색의 다섯 가지 빛으로 빛나며 악마를 막아냅니다.', word: '오방색', options: ['무지개 색', '한국 전통의 다섯 가지 방위 색', '수채화 물감', '음식 색소'], answer: 1, difficulty: 'kpdh' },
  ...
  { id: 1952, sentence: '영화에서 감독은 자신의 아바타를 매 공연 장면마다 몰래 등장시켰습니다.', word: '아바타', options: ['악령의 이름', '자신을 대신하는 캐릭터나 분신', '팬클럽 회장', '조연 배우'], answer: 1, difficulty: 'kpdh' },
